...
ActiveRecord::Schema.define(version: 20161129162928) do
  ...
  create_table "bookings", force: :cascade do |t|
    ...
    t.index ["republica_id"], name: "index_bookings_on_republica_id", using: :btree
  ...
  add_foreign_key "bookings", "republicas"
